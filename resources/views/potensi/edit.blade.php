        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              <!-- /.card-header -->
              <div class="card-body">
                <form class="" action="{{ route('potensi.update', $data->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('POST')
                        ...
                        <div class="col">
                            <label for="demo_overview_minimal">Perusahaan</label>
                              <select data-live-search="true" id="company" class="form-control" data-role="select-dropdown" data-profile="minimal" name="company_id" value="" selected="">                                  
                                  ...
                                  <option value="{{ $item->id }}" {{$data->company_id == $item->id  ? 'selected' : ''}}>{!! Str::limit($item->company_name, 40) !!}</option>
                                  @endforeach
                              </select>
                        </div>
                        <div class="col">
                            ...
                            <div class="input-group mb-2">
                                ...
                                <input type="text" class="form-control" id="potensi" placeholder="1.000.000" name="potensi" value="{{$data->potensi}}">
                            </div>
                        </div>
                    </div>
                    <div class="row" style="padding-top: 10px">
                        ...
                        <div class="col">
                            ...
                            <div class="input-group mb-2">
                                ...
                                <input type="text" class="form-control" id="aktual_revenue" placeholder="1.000.0000" name="aktual_revenue" value="{{$data->aktual_revenue}}">
                            </div>
                        </div>
                    </div>
