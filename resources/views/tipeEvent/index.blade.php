                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <form action=" {{route('tipeEvent.store')}} " method="post" enctype="multipart/form-data">
                          @csrf                          
                            <div class="form-group">
                              <label for="formGroupExampleInput2">Nama Tipe Event</label>
                  ...
                  <tbody>
                    @foreach($data as $item)
                      <tr style="text-align:center;">
                        ...
                        <td title="">
                            <form action="{{route('tipeEvent.destroy', $item->id)}}" method="POST">
                                <a href="{{route('tipeEvent.edit', $item->id)}}" class="btn btn-success btn-sm" role="button" aria-disabled="true"><i class="fas fa-edit"></i></a>
                                @csrf
                                @method('post')
