        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              <!-- /.card-header -->
              <div class="card-body">
                <form class="" action="{{ route('project-income.store', $dataEvent->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('POST')
                    <div class="row">
                        <div class="col">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="input-group mb-2">
                                        ...
                                        <input type="text" class="form-control" id="income_we" placeholder="" name="income_we">
                                    </div>
                                    ...
                                    <div class="input-group mb-2">
                                        ...
                                        <input type="text" class="form-control" id="ppn_we" placeholder="" name="ppn_we">
                                    </div>
                                    ...
                                    <div class="input-group mb-2">
                                        ...
                                        <input type="text" class="form-control" id="pph_we" placeholder="" name="pph_we">
                                    </div>
                                </div>
                              </div>
                        </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="input-group mb-2">
                                        ...
                                        <input type="text" class="form-control" id="income_partner" placeholder="" name="income_partner">
                                    </div>
                                    <label for="demo_overview_minimal">PPN</label>
                                    <div class="input-group mb-2">
                                        <div class="input-group-prepend">
                                        ...
                                        <input type="text" class="form-control" id="ppn_partner" placeholder="" name="ppn_partner">
                                    </div>
                                    <label for="demo_overview_minimal">PPH</label>
                                    <div class="input-group mb-2">
                                        <div class="input-group-prepend">
                                        ...
                                        <input type="text" class="form-control" id="pph_partner" placeholder="" name="pph_partner">
                                    </div>
                                </div>
                              </div>
                        </div>
